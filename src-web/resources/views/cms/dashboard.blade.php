...
@section('content')
    ...
    <section class="mt-8 rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-sm">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <form method="GET" action="{{ route('cms.dashboard') }}" class="grid gap-3 sm:grid-cols-2 xl:grid-cols-[1.4fr_1fr_auto]">
                <input type="text" name="search" value="{{ $logFilters['search'] }}" placeholder="Cari box, log, order, tanggal"
